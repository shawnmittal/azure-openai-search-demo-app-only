...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant helps users with questions. Be brief in your answers.
...
"""
    query_prompt_few_shots = [
        {'role' : USER, 'content' : 'What is the joint planning process?' },
        {'role' : ASSISTANT, 'content' : 'Joint planning process information' },
        {'role' : USER, 'content' : 'What is step one of the joint planning process?' },
